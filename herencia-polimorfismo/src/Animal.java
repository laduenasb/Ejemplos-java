...
/* Las clases abstractas son clases que no se pueden instanciar.
  ...
  * La clase abstracta puede contener metodos abstractos y
  * metodos concretos.
...
public abstract class Animal {
  ...
  private Animal(int numSerie){
    ...
    // Codigo que solo será accesible por la misma clase
  }
  ...
  /*
  * La sobrecarga de métodos se refiere a la capacidad de una clase
  * de tener múltiples métodos con el mismo nombre, pero con diferentes lista de parámetros.

  * La sobrecarga de método se basa en la firma del método,
  * que incluye el nombre del método y el tipo, orden y número de parámetros.
  @return
   */
  public String comer(){
  ...
  /**
   * Se tine que colocar el alimento
   */
  ...
  public String comer(String alimento, double gramaje){
    return comer()+ " " + gramaje + " gramos de " + alimento;
  }
  /**
